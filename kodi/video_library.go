...
func (vl *VideoLibrary) SetEpisodeDetails(episodeId int, params map[string]any) bool {
...
func (vl *VideoLibrary) SetMovieDetails(movieId int, params map[string]any) bool {
